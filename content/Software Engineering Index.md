...
publish: true
created: "[[2022-11-15]]"
modified: 2026-01-11T18:20:39.463+02:00
...
- Concepts 
	- [[Composition]] - using classes to build more complex classes, a lot like what [[Go\|Go]] enforces.
...
- Software Development Lifecycle
	- [[Code Review]]
- Writing [[Performance\|performant]] code
- Properties Of Software Engineering
	- [[Asynchronous\|Asynchronicity]] is the capability of a system to handle multiple processes at the same time 
	- [[Immutability]] is the practice of working with copies of a data structure rather than references
	- [[Idempotent\|Idempotency]] - is the property of a function that can be called multiple times without changing the result.
- Low Level
	- [[Interpreters]]
- Advanced
	- [[State Machine]]
