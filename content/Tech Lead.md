...
aliases:
  - Team Lead
created: "[[2025-04-08]]"
modified: 2026-01-12T09:27:46.368Z
...
- ❓**[[Troubleshooting|Problem Solving]]**: Lead the team in **solving technical challenges**, wether through research, discussion, or hands-on coding. They often take on the most complex or high-risk tasks.
...
- Planning & [[Prioritization]] - Work with [[Product Manager|product managers]], [[Project Manager|project managers]], and [[Stakeholders]] to define tasks, allocate work, and ensure the team is working on the right priorities.
- Tracking Progress - Monitor the team's progress, ensuring that deadlines are met, and identify and address [[Blocker|blockers]].
...
- [[Work-Life Balance]] - Ensure the team is **working at a sustainable pace** and doesn't burn out, which includes managing workloads and [[Managing Expectations|expectations]].
