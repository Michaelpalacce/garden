...
aliases:
  - Solution Design
created: "[[2024-02-19]]"
modified: 2026-01-11T13:22:54.052Z
...
- Address any trade-offs that were considered during the design process.
  - It's good to outline these, so later on that can be used as reference.
    - _For example lets say you looked into a potential alternative to something and decided that it is not applicable, then during development if a developer stumbles on the same questions, they can verify it against what was documented_
...
- Provide rationale for the selection of each technology.
  - Same as the [[#Design Considerations]], justify your decisions, outline any trade-offs
