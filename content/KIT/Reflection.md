...
Some information becomes engraved in your mind, the neurological pathways formed and overall [[Durable Knowledge\|the information is very durable]] to the point where recalling it and acting on it become a reflex.
...
Use reflection to **create future goals**. When thinking about a specific event, upon discovery that there is a better way for that event to have been handled, create a goal in your mind (or [[KIT/Command & Control Center Index\|vault]]) to **next time attempt the new solution**.
